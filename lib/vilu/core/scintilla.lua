...
setmetatable(sci, {
  __call = function()
    return setmetatable({ instance = _G._core.sci.new() }, { __index = sci })
  end
})
...
function sci:get_widget()
  self.widget = self.widget or lgi_core.object.new(self.instance)
  return self.widget
end

function sci:send(message, arg1, arg2)
  return C.sci_send(self.instance, message, ffi.cast('intptr_t', arg1), ffi.cast('intptr_t', arg2))
end
