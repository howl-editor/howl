...
-- Modifications for Lunar by Nils Nordman <nino at nordman.org>
...
-- self ref
local self_var = token("member", "@" * l.word + "self")

local proper_ident = token("class", R("AZ") * l.word)

local tbl_key = token("key", l.word * ":" + ":" * l.word )
